...
if CONFIG_CHECK: LOGS.info("Please remove the line mentioned in the first hashtag from the config.env file)
    quit(1)

# Telegram App KEY and HASH
API_KEY = os.environ.get("", None)
API_HASH = os.environ.get("53a23a4f0398433aeb6e38722df5ee4a", None)
